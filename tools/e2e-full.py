...
try:
    with sync_playwright() as p:
        ...
        pg.click('#st-play'); pg.wait_for_timeout(600)
        st_lyr_len = pg.eval_on_selector('#st-lyrics', 'e=>e.value.length')
        pg.click('.stlyr-head .toggle'); pg.wait_for_timeout(1600)
        st_scroll = pg.eval_on_selector('#st-lyrics', 'e=>e.scrollTop')
